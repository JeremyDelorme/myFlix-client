...
export class ProfileView extends React.Component {
    ...
    getUser = (token) => {
        ...
        axios
            .get(`https://movie-api-jeremydelorme.herokuapp.com/users/${Username}`, {
    ...
    editUser = (e) => {
        ...
        axios
            .put(
                `https://movie-api-jeremydelorme.herokuapp.com/users/${Username}`,
                {
    ...
    onDeleteUser() {
        ...
        axios
            .delete(`https://movie-api-jeremydelorme.herokuapp.com/users/${Username}`, {
                headers: { Authorization: `Bearer ${token}` },
            })
            .then((response) => {
                console.log(response);
